...
class Prediction:
    ...
    def predictLetter(self,thresHoldedImage):
        ...
        if self.totalPredictCount==75:          #Karar verme sürecinde timer dikkate alınacak, gerekli değişiklikler yapılacak. Listenin ilk harfi 3 saniye boyunca aynı kalırsa,yazma işlemi olacak. 
            print("Gercek Sonuc:"+self.letterList[len(self.letterList)-1])
            self.totalPredictCount=0
    ...
    def kerasPredict(self,image):
        processed = self.cnnModel.keras_process_image(image)
