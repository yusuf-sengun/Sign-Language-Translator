# -*- coding: utf-8 -*-
"""
Created on Mon Mar 22 23:52:57 2021
...
filepath=r"C:\Users\olgun\Desktop\SignLanguageProject\weights.best.hdf5"
...
def runFingerCounter():
    ...
    while (cap.isOpened()):
        ...
        contours,hierarchy=cv2.findContours(mask_hsv.copy(),cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
        ...
        if len(contours) > 0:
            ...
            if cv2.contourArea(cnt) > 2500: 
                ...
                formatted_pred_acc=format(round(pred_probab,2)*100,'.2f')
                cv2.putText(img,"%"+formatted_pred_acc,(0,90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 1, cv2.LINE_AA)
