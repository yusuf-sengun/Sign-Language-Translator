...
class EducationPage(QWidget):
    def __init__(self,app):
        ...
        self.predictedInfoLabel.setText("Result:")
        ...
        self.predictedText.setStyleSheet("background-color: rgba(255, 255, 255, 10); color:black; font-size:24px;")
    ...
    def update_image(self, cv_img):
        ...
        if self.thread.isHandInRectangle==True:
            if(self.isButtonClicked==True):
                ...
                self.predictedText.setText("Please, choose a letter that you want to predict!")    
        else:
    ...
    def setPredictedText(self):
        ...
        if lenPredictedLetterList!=0 and self.predictedLetter[lenPredictedLetterList-1]==self.targetPredictedLetterStr:
            self.predictedText.setStyleSheet("background-color: rgba(255, 255, 255, 10); color:green; font-size:24px;")
            self.predictedText.setText("Correct!")   
        else:
            self.predictedText.setStyleSheet("background-color: rgba(255, 255, 255, 10); color:red; font-size:24px;")
