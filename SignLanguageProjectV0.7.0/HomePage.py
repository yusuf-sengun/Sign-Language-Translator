...
class Home(QMainWindow):
    def __init__(self,app): 
        ...
        infoButton.setToolTip('<b>Release </b>v0.7.0<br><b>Model </b>v0.3.0<br><b>KODBY US</b>')
        ...
        kodbyUsLabel.move(windowWidth-150,windowHeight-30)######################SORUN VARRRRRRRRRRRRRRRRRRRRRRRRRRR###############3
